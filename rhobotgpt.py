...
with open('F:/RHO-BOT/preprocessed_text.txt', 'r', encoding='utf-8') as f:
    text = f.read()
...
# Save the model
torch.save(model.state_dict(), 'F:/RHO-BOT/gpt_language_model.pth')


# Function to Load the Model for Chatting
def load_model_for_chat(model_path):
    model = GPTLanguageModel()
...
def chat_with_model(prompt, model, max_new_tokens=50):
...
model_for_chat = load_model_for_chat('F:/RHO-BOT/gpt_language_model.pth')

# Example Chat Interaction
input_text = "Hello, how are you?"
response = chat_with_model(input_text, model_for_chat)
print(response)
